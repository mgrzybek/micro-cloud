...
[Semantic Versioning](https://semver.org/), with a [Keep a Changelog](https://keepachangelog.com/)
`CHANGELOG.md` generated by [git-cliff](https://git-cliff.org). Pushing a signed `vX.Y.Z` tag
...
few version pins in the bootstrap scripts) are kept up to date by [Renovate](https://docs.renovatebot.com/)
(`renovate.json`).
